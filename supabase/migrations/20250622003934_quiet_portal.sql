/*
  # Crear tabla de conversaciones para remember_chat
...
-- 6. Políticas RLS para seguridad
-- Política para permitir que todos lean conversaciones (ajustar según necesidades)
...
-- Política para permitir actualizar conversaciones
CREATE POLICY "Anyone can update conversations" ON conversations
  FOR UPDATE USING (true);

-- Política para permitir eliminar conversaciones (solo administradores)
...
-- SELECT * FROM get_conversation_history('conv_123', 20, 0);
-- SELECT clean_old_conversations(30);
